...
<body class="text-gray-800">
    ...
    <nav class="fixed w-full z-50 glass px-6 py-4 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <div class="flex items-center gap-3 cursor-pointer group" onclick="showSection('home')">
                <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-2xl group-hover:rotate-12 transition-transform">👁️</div>
            ...
            <button onclick="toggleMobileMenu()" class="md:hidden text-white text-2xl hover:rotate-90 transition-transform">☰</button>
        </div>
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div class="text-white space-y-6 z-10">
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 rounded-full text-sm font-bold mb-2 backdrop-blur-sm border border-white/30 hover:bg-white/30 transition cursor-pointer" onclick="showSection('tests')">
                    <span class="animate-pulse">🎮</span> Fun & Educational
                ...
                <div class="flex flex-wrap gap-6 pt-6 text-sm opacity-90">
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                        <span class="text-green-400 text-xl">✓</span> Free & Safe
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                        <span class="text-blue-400 text-xl">✓</span> Doctor Approved
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                        <span class="text-pink-400 text-xl">✓</span> Kid Friendly
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex justify-center items-center">
                <div class="relative floating">
                    ...
                    <div class="absolute -top-8 -right-8 w-16 h-16 bg-yellow-300 rounded-full opacity-80 floating-delayed flex items-center justify-center text-2xl">✨</div>
                    <div class="absolute -bottom-4 -left-8 w-12 h-12 bg-pink-400 rounded-full opacity-80 flex items-center justify-center text-xl" style="animation: float 5s ease-in-out infinite reverse;">💜</div>
                    <div class="absolute top-1/2 -right-16 text-6xl floating-delayed cursor-pointer hover:scale-110 transition-transform" onclick="waveMascot()">👋</div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-12 glass-card rounded-2xl p-6 max-w-2xl mx-auto">
                ...
                <div id="completion-message" class="hidden mt-3 text-center text-sm font-bold text-purple-600">
                    🎉 Amazing! You've completed all tests!
                </div>
            </div>

            <div class="mt-12 text-center">
                <button onclick="showSection('home')" class="text-white/80 hover:text-white font-semibold underline underline-offset-4 transition">← Back to Home</button>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-500">Test 1 of 3 • Visual Acuity</p>
                </div>
                <button onclick="showSection('tests')" class="text-gray-400 hover:text-gray-600 text-2xl transition hover:rotate-90">✕</button>
            </div>

            <div class="bg-blue-50 rounded-3xl p-8 mb-8 border-2 border-blue-100">
                <div class="flex items-start gap-4 mb-6">
                    <div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white text-xl shadow-lg">💡</div>
                    <div class="flex-1">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-500">Test 2 of 3 • Astigmatism Check</p>
                </div>
                <button onclick="showSection('tests')" class="text-gray-400 hover:text-gray-600 text-2xl transition hover:rotate-90">✕</button>
            </div>
            ...
            <div class="bg-purple-50 rounded-3xl p-8 border-2 border-purple-100">
                <div class="flex items-start gap-4 mb-8">
                    <div class="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white text-xl shadow-lg">👁️</div>
                    <div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-500">Test 3 of 3 • Color Vision</p>
                </div>
                <button onclick="showSection('tests')" class="text-gray-400 hover:text-gray-600 text-2xl transition hover:rotate-90">✕</button>
            </div>
            ...
            <div class="bg-green-50 rounded-3xl p-8 border-2 border-green-100">
                <div class="flex items-start gap-4 mb-8">
                    <div class="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white text-xl shadow-lg">🎨</div>
                    <div class="flex-1">
    ...
    <section id="learn" class="hidden-section pt-24 pb-12 px-4 min-h-screen grid-bg">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="glass-card rounded-3xl p-8 hover:shadow-2xl transition-shadow">
                    ...
                    <div class="bg-blue-100 rounded-2xl p-4 mb-4 h-48 flex items-center justify-center relative overflow-hidden group">
                        <div class="absolute inset-0 flex items-center justify-center transition-transform group-hover:scale-110">
                            <div class="text-6xl z-10">👁️</div>
                            <div class="text-4xl ml-8 blur-sm opacity-50">🏔️</div>
                            <div class="absolute text-5xl left-10 top-10 opacity-20">📍</div>
                        </div>
                ...
                <div class="glass-card rounded-3xl p-8 hover:shadow-2xl transition-shadow">
                    ...
                    <div class="bg-orange-100 rounded-2xl p-4 mb-4 h-48 flex items-center justify-center relative overflow-hidden group">
                        <div class="absolute inset-0 flex items-center justify-center transition-transform group-hover:scale-110">
                            <div class="text-4xl blur-sm opacity-50">📖</div>
                            <div class="text-6xl ml-8 z-10">👁️</div>
                            <div class="absolute text-5xl right-10 bottom-10 opacity-20">🔭</div>
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-2 text-gray-600">
                            <li class="flex items-center gap-2">
                                <span class="text-purple-500">•</span> Can cause headaches from eye strain
                            </li>
                            <li class="flex items-center gap-2">
                                <span class="text-purple-500">•</span> Makes lights look streaky or starry at night
                            </li>
                            <li class="flex items-center gap-2">
                                <span class="text-purple-500">•</span> Special cylindrical lenses fix it easily!
                            </li>
                        </ul>
                    </div>
            ...
            <!-- Fun Facts -->
            <div class="glass-card rounded-3xl p-8 mb-8">
                <h3 class="text-2xl font-bold text-gray-800 mb-6 fun-font">🌟 Amazing Eye Facts!</h3>
            ...
            <div class="glass-card rounded-3xl p-8">
                <h3 class="text-2xl font-bold text-gray-800 mb-6 fun-font">🛡️ Super Eye Care Tips</h3>
            ...
            <div class="glass-card rounded-3xl p-8 md:p-12 shadow-2xl">
                ...
                <div class="prose prose-lg text-gray-600 space-y-4">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 my-6 rounded-r-lg">
                        <p class="font-bold text-blue-800 mb-1">👨‍⚕️ Important Medical Disclaimer:</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 my-6">
                        <div class="bg-gray-50 p-4 rounded-xl">
                            <div class="font-bold text-gray-800 mb-1">🎯 Our Mission</div>
                            <div class="text-sm">Make vision health awareness accessible and fun for every child.</div>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-xl">
                            <div class="font-bold text-gray-800 mb-1">🔒 Privacy First</div>
                    ...
                    <div class="text-center pt-6 border-t border-gray-200 mt-6">
                        <p class="text-sm text-gray-500 mb-4">Made with 💜 for curious kids</p>
                        <div class="flex justify-center gap-4 text-2xl">
                            <span class="hover:scale-110 transition cursor-pointer" title="We love eyes!">👁️</span>
                            <span class="hover:scale-110 transition cursor-pointer" title="Learning is fun!">📚</span>
                            <span class="hover:scale-110 transition cursor-pointer" title="Stay healthy!">🌟</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function checkAstigmatism(hasAstigmatism) {
            ...
            if (hasAstigmatism) {
                resultDiv.innerHTML = `
                    <div class="result-badge text-6xl mb-4">🔍</div>
